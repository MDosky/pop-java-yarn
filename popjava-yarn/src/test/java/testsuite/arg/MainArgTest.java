...
public class MainArgTest {
    ...
    public static void main(String... argvs) {
        try {
            ...
            if (!s1.equals(s2)) {
                throw new Exception("Test failed because of String arg");
            }
            ...
            byte bb = pop.getByte();
            if (bb != b) {
                throw new Exception("Test failed because of byte arg");
            ...
            if (s != sback) {
                throw new Exception("Test failed because of short arg");
            }

            pop.setInt(222);
            int val = pop.getInt();
            if (val != 222) {
                throw new Exception("Test failed because of int arg");
            }

            pop.setDouble(2.5);
            double valD = pop.getDouble();
            if (valD != 2.5) {
                throw new Exception("Test failed because of double arg");
            }
            ...
            if (valF != 3.44f) {
                throw new Exception("Test failed because of float arg");
            }
            ...
            for (int i = 0; i < aChar.length; i++) {
                if (aChar[i] != aaChar[i]) {
                    throw new Exception("Test failed because of char[] arg");
                }
            }
            ...
            pop.setBoolean(true);
            if (!pop.getBoolean()) {
                throw new Exception("Test failed because of boolean arg");
            }
            ...
            for (int i = 0; i < blArray.length; i++) {
                if (blArray[i] != lArray[i]) {
                    throw new Exception("Test failed because of long[] arg");
                }
            }
