...
public class YARNContainer {
    ...
    private void startDaemon() {
        ...
        String daemonCmd = "java -cp popjava.jar:yarn-app.jar popjava.yarn.DaemonService %s";
    ...
    private void startMainContainer() {
        String popjava = "java -javaagent:popjava.jar -cp popjava.jar:yarn-app.jar %s %s";
